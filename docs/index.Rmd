...
pr_table    <- function(csv_link) glue('<a href = "{csv_link}"><span class="fa fa-search"></span></a>')
pr_map      <- function(geojson) glue('<a href = "{geojson}"><span class="fa fa-search"></span></a>')
